...
// FIXME: this should definitely be an object and not an enormous argset
export const streamEvents = async (authUser, postBuffer, setPostBuffer, postBufferCount, setPostBufferCount, notificationsBuffer, setNotificationsBuffer, notificationsBufferCount, setNotificationsBufferCount) => {
                ...
                if (event.indexOf(':') === 0) {
                    ...
                    switch (type) {
                        ...
                        case "notification":
                            ...
                            let mergedBuffer2 = await mergeWithoutDupes(notificationsBuffer, [data])
                            notificationsBuffer = mergedBuffer2
                            setNotificationsBuffer(notificationsBuffer)
                            notificationsBufferCount = notificationsBufferCount + 1
                            setNotificationsBufferCount(notificationsBufferCount)
                            break
                        default:
